...
var transporter = nodemailer_1.default.createTransport({
    host: config_js_1.SENDER_HOST,
    port: config_js_1.SENDER_PORT,
    auth: {
        user: config_js_1.SENDER_USER,
        pass: config_js_1.SENDER_PASSWORD,
    },
    debug: true,
    tls: {
...
var output = mustache_1.default.render("{{title}} spends {{calc}}", view);
...
var slugFromUser = function (user) {
